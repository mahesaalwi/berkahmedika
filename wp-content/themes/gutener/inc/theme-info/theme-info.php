...
$config = array(
    ...
    'quick_links' => array(
        ...
        'rate_url'  => array(
            ...
            'url' => 'https://wordpress.org/support/theme/' .$theme_name_config_url. '/reviews/?filter=5'
        ),  
    ),
    ...
    'faq' => array(
        'first' => array (
            ...
            'desc' => sprintf(esc_html__( '%s supports Kirki, Gutentor, Smash Balloon, WooCommerce and AddToAny','gutener' ), $theme_name_config ),
            'is_new_tab' => true
        ),
    ),
    // Support content tab.
    ...
    'rating' => array(
        'first'=> array(
            ...
            'desc' => esc_html__( 'If you like our work, please give us a moment of your time to rate our theme 5 stars on ','gutener' ) .'<a target="_blank" href="https://wordpress.org/support/theme/' .$theme_name_config_url. '/reviews/?filter=5">' . 'wordpress.org' . '</a>' . esc_html__('. It will give us more energy to work on this theme.', 'gutener' ),
            'link_title' => esc_html__( 'Rate Theme','gutener' ),
            'link_url' => 'https://wordpress.org/support/theme/' .$theme_name_config_url. '/reviews/?filter=5',
            'is_button' => true,
            'is_new_tab' => true
        )
    )
