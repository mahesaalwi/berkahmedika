...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			$this->abs_path_to_url( dirname( __FILE__ ).'/alpha-color-picker.js'),
		...
		wp_enqueue_style(
			'alpha-color-picker',
			$this->abs_path_to_url( dirname( __FILE__ ).'/alpha-color-picker.css'),
	...
	public function render_content() {
		...
		<label>
			<input class="alpha-color-control" type="text" data-show-opacity="<?php echo esc_attr($show_opacity); ?>" data-palette="<?php echo esc_attr( $palette ); ?>" data-default-color="<?php echo esc_attr( $this->value() ); ?>" <?php $this->link(); ?>  />
		</label>
		<?php
	}
}
