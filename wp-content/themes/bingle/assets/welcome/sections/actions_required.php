...
if( !empty($this->actions_req) ) {
	if($this->actions_req['pro_plug'] != null){
		?>
					...
					<div class="recom-plugin-inner-wrapper">
						<div class="plugin-title-install clearfix">
							...
							<div class="version-author-info free">
								<span class="version"><?php echo esc_html__('Version ', 'bingle') . esc_html($plugin['version']); ?></span>
	...
	if($this->actions_req['free_plug'] != null){
		?>
				...
				<div class="recom-plugin-wrap ">
					<div class="recom-plugin-inner-wrap">
						<div class="plugin-title-install clearfix">
							...
							<div class="version-author-info free">
								<span class="version"><?php echo esc_html__('Version ', 'bingle') . esc_html($info->version); ?></span>
								<span class="seperator">|</span>
